// в кратце задача о просто нахождение и ж того индекса в ДВУМЕРНОМ массиве тоже самое операция как и у в ОБЫЧНОМ массиве
// просто вы еще должны посмотреть когда наша строка являтся четной и не четной задача легкая
#include <bits/stdc++.h>
using namespace std;
